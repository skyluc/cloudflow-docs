...
[source, scala]
----
include::1.3.1@docsnippets:ROOT:example$spark-scala/src/main/scala/cloudflow/sparkdoc/MovingAverageSparklet.scala[tag=spark-streamlet-example]
----
...
[source, json]
----
include::1.3.1@docsnippets:ROOT:example$spark-scala/src/main/blueprint/blueprint.conf[]
----
